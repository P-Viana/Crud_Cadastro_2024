...
namespace ProjCrudCadastro_PEDRO
{
    public partial class frmCliente : Form
    {
        ...
        private void ExibirDados()
        {
            ...
            dtgClientes.DataSource = dt.AsDataView();
        }
        ...
        private void dtgCliente_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cliente.SetId(Convert.ToInt32(dtgClientes.Rows[e.RowIndex].Cells[0].Value));
            cliente.SetNome(dtgClientes.Rows[e.RowIndex].Cells[1].Value.ToString());
            cliente.SetTelefone(dtgClientes.Rows[e.RowIndex].Cells[2].Value.ToString());

            cliente.SetSexo(dtgClientes.Rows[e.RowIndex].Cells[3].Value.ToString());
        ...
        private void btnAlterar_Click_1(object sender, EventArgs e)
        {
            ...
            if (txtNome.Text != "" && txtTelefone.Text != "" && int.TryParse(lblID.Text, out int
            id))
            {
                // Define os valores do cliente a partir dos campos do formulário
                cliente.SetId(id);
